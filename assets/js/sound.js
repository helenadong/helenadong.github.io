$(document).ready(function() {
  ...
  sideNavItem4.setAttribute('src', 'assets/audio/crack.mp3' , type="audio/mpeg");
  $.get();
  ...
  sideNavItem10.setAttribute('src', 'assets/audio/birdchirp.mp3' , type="audio/mpeg");
  $.get();
  ...
  sideNavItem11.setAttribute('src', 'assets/audio/glitch5.mp3' , type="audio/mpeg");
  $.get();
  ...
  sideNavItem13.setAttribute('src', 'assets/audio/violin.mp3' , type="audio/mpeg");
  $.get();
  ...
  sideNavItem14.setAttribute('src', 'assets/audio/ufo.mp3' , type="audio/mpeg");
  $.get();
